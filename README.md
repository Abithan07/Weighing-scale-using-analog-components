...
<img src="https://github.com/user-attachments/assets/1dd06a0f-faa8-4684-85c9-5c6d5c97a2cd" width="300">

### Operational Amplifier circuit for reference:

<img src="https://github.com/user-attachments/assets/f811dbac-35f3-470d-9282-8ca6dd0eaba8" width="300">

### Schematic Diagram of our Circuit:

<img src="https://github.com/user-attachments/assets/a9bd57c5-d465-43f6-8e01-36364330c46e" width="800">
...
<img src="https://github.com/user-attachments/assets/feef5c6f-1fd6-4773-a355-b461c911813b" width="800">

A microcontroller unit had to be implemented to display the output on a 16x2 LCD display.
The augmentation of the weight measurement system involves the integration of a 16-bit ADS1115 Module and an ESP32 WROOM 32E module. This addition enhances the capabilities of the instrumental amplifier and the voltage adder circuit. The ADS1115 Module serves as a high-precision Analog-to-Digital Converter (ADC), while the ESP32 WROOM 32E module acts as the micro-controller responsible for data processing and interfacing with the external display. The collaboration of these components introduces digital processing capabilities to the analog weight measurement system. The schematic for the microcontroller is below

<img src="https://github.com/user-attachments/assets/b44531e9-52e1-42a6-ac90-851d7d5f9a32" width="800">

### PCB Layout:

<img src="https://github.com/user-attachments/assets/9bcf2b4d-b7cb-4d3b-8d17-59f69787ba2f" width="500">
<img src="https://github.com/user-attachments/assets/7d69f172-fd68-4c5f-85f2-e3259b64c1b7" width="300">

### Enclosure:

<img src="https://github.com/user-attachments/assets/4c52742f-4a28-41b7-9f17-0f0a9162d507" width="500">
<img src="https://github.com/user-attachments/assets/21cda94e-5eb3-45b7-b686-18a0ceb594f4" width="400">
